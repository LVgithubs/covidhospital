...
public class CovidMainApp {
 ...
 /**
        ...
        **/
        ...
        System.out.println("Ex:김해시 , 사상구");
        //String sgguCdNm = sc.nextLine();
        String sgguCdNm = "김해시";
        
        System.out.println("======호흡기 전담 클리닉 가능 여부가 필요한가요?======");
        System.out.println("Ex:Y , N");
       // String rprtWorpClicFndtTgtYn = sc.nextLine();
        String rprtWorpClicFndtTgtYn = "Y";
       ...
       /// String ratPsblYn = sc.nextLine();
        ...
        List<Hospital> hospitals= databased.listSelect(sidoCdNm, sgguCdNm,rprtWorpClicFndtTgtYn, ratPsblYn, pcrPsblYn);
